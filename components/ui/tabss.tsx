...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row gap-24 items-center justify-between mt-10 text-xl font-extrabold [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full w-full text-white",
          containerClassName
        )}
      >
